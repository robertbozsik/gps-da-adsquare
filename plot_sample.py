...
# open final_df
final_df = pd.read_csv("./out_data_sample/analysis.csv")
...
if __name__ == "__main__":
    if len(sys.argv) == 2:
        ...
        print("""
        python(3) plot_sample.py $params
        e.g. python(3) plot_sample.py plot_all_stores (Plot and save the unique visits of each sotre.)
             python(3) plot_sample.py plot_a_store Aldi (Plot and save the unique visits of the selected store.)
